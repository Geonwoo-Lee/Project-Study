...
| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | TIL, Sprint, 스터디 회의| 이건우, 이장희, 김동우, 정종화| 오후 1시 | 4 |
| 화 | TIL, Sprint, 스터디 회의| 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 수 | TIL, Sprint, | 이건우, 이장희, 김동우, 정종화| 자율 | - |
| 목 | TIL, Sprint, | 이건우, 이장희, 김동우, 정종화| 자율 | - |
| 금 | TIL, Sprint, 스터디 회의 | 이건우, 이장희, 김동우, 정종화| 오후 8시 | - |
| 토 | TIL | 이건우, 이장희, 김동우, 정종화| - | - |
| 일 | TIL | 이건우, 이장희, 김동우, 정종화| - | - |
...
## **➣ ✅ Weekly To do List**
- 테마는 동우님이 보내주신걸로 선택 되었습니다 구체적인 와이어프레임은 장희님께 금요일까지 부탁 드렸습니다 . 바쁘시겠지만 부탁 드리겠습니다 🙏

- 화요일에는 git branch 에 대한 실습이 있습니다 그래서 git branch의 branch 산개 및 병합 branch 디자인에 대하여 공부를 하고 오면 좋을 것 같습니다 . 
  1. git branch는 오늘 제가 보여드린걸 토대로 git branch map을 살펴보고 이해하시면 좋을 것 같습니다 .
  2. git 협업 명령어 (코드스테이츠에 있는거 정도)만 익숙하게 다루 실 수 있게 해주시면 감사하겠습니다 .
  3. 내일(화요일)에는 간단한 Twittler를 가지고 진행을 해볼 계획입니다 main branch에 들어갈 구체적인 틀은 제가(이건우) 만들어서 내일 실습을 진행하면 될 것 같습니다  .
  4. git 실습 할때 해야하는 것은 commit 메세지 구체적으로 작성하는 연습 , 충돌 방지 , issue 활용 , Projects를 사용하여 작업 현황을 알리기 , branch 다루기 등을 할 예정입니다 .
  
- 금요일 회의에명절 스케쥴을 짜볼것이고 금요일부터 명절 전까지 저희가 프로젝트를 진행 하면서 어떤것들을 정해 놓고 해야하는지를 정하는 목록을 작성해 볼 것입니다 . 장희님이 보내주신 링크를 토대로 보고 무엇을 준비하면 좋을지 생각해보면 좋을 것 같습니다 . 또한 장희님이 디자인 해주신 와이어프레임을 통해서 어떤 컴포넌트와 라우터를 몇개 가질 것인지 로그인 방식에는 어떤걸 체택할 것인지를 결정 하게 됩니다 .

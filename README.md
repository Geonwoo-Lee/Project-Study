...
## **➣ ✅ Weekly To do List**
- 프로젝트의 주제에 대해 후회없는 선택을 할 수 있도록 잘 생각해 봅시다 2가지의 경우가 있습니다 .
  1. 장희님의 아이디어 대로 주제를 정하고 싶다면 그 아이디어를 토대로 어떤 기능이 있는 웹사이트가 있는지에 대해 생각해 봅시다 .
  2. 다른 아이디어가 있다면 그 아이디어에 대한 구체적인 설명을 통해 다른분들에게 설명 해야 합니다 .
- 장희님의 아이디어와 다른 아이디어에 대한 투표가 있을 예정입니다 . 다른 아이디어가 없다면 픽스 입니다 .
- 월요일에는 무조건 주제를 픽스 합니다 .

...
| 토 | TIL | 이건우, 이장희, 김동우, 정종화| - | - |
| 일 | 프로젝트 회의 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | 4 |

### 5주차 회의 
| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | 명절| 이건우, 이장희, 김동우, 정종화| - | 5 |
| 화 | 명절| 이건우, 이장희, 김동우, 정종화| - | - |
| 수 | 명절 | 이건우, 이장희, 김동우, 정종화| - | - |
| 목 | 프로젝트 회의 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 금 | 프로젝트 회의 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 토 | 프로젝트 회의 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 일 | TIL | 이건우, 이장희, 김동우, 정종화| - | - |

### 6주차 회의 
| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | 명절| 이건우, 이장희, 김동우, 정종화| - | 6 |
| 화 | 명절| 이건우, 이장희, 김동우, 정종화| - | - |
| 수 | 명절 | 이건우, 이장희, 김동우, 정종화| - | - |
| 목 | 프로젝트 회의 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 금 | 데이터베이스 스키마 디자인, 디자인 계획 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 토 | 미정 | 이건우, 이장희, 김동우, 정종화| 미정 | - |
| 일 | TIL | 이건우, 이장희, 김동우, 정종화| - | - |

### 7주차 회의 
| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | HA 준비 | 이건우, 이장희, 김동우, 정종화| - | 7 |
| 화 | 네이밍 생각 해오기 | 이건우, 이장희, 김동우, 정종화| 8시 | - |
| 수 | HA, 부족한 회의가 있다면 회의  | 이건우, 이장희, 김동우, 정종화| 8시 | - |
| 목 | API 플로우 차트 만들기 목요일까지 각자 생각하는 부분 플로우차트 어느정도 만들어오기 | 이건우, 이장희, 김동우, 정종화| 오후 1시 | - |
| 금 | 미정 | 이건우, 이장희, 김동우, 정종화| 미정 | - |
| 토 | 개인 기능구현 | 이건우, 이장희, 김동우, 정종화| - | - |
| 일 | 개인 기능구현 | 이건우, 이장희, 김동우, 정종화| - | - |
